...
ok(urls.length === 10, 'sitemap exposes ten canonical pages');
...
ok((worker.match(/staticTitle:/g) || []).length === 8, 'all deep and locale routes have static titles');
ok((worker.match(/staticDescription:/g) || []).length === 8, 'all deep and locale routes have static descriptions');
