...
ok(index.includes("var LOCALE=localePath==='/tr'?'tr':localePath==='/es'?'es':localePath==='/fr'?'fr':localePath==='/ja'?'ja':'en';"), 'Runtime locale follows crawlable paths');
...
ok(index.includes('var HELP_COPY={tr:TR_HELP,es:ES_HELP,fr:FR_HELP,ja:JA_HELP};'), 'Locale help catalogs share one selection boundary');
...
ok(index.includes("['en','tr','es','fr','ja'].indexOf(target)<0"), 'lang command allowlists all five languages');
