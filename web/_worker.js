...
const ENTRY_ROUTES = {
  ...
  "/ja": {
    ...
    description: "実際のロケット打ち上げを、ライブカウントダウン、ミッション状況、射点の天気、公式配信リンクとともにDOS風宇宙ターミナルで探索できます。",
    staticTitle: "LIVE SPACEFLIGHT TERMINAL",
    staticDescription: "次の実際の打ち上げ、ライブT-0カウントダウン、ISSの位置、宇宙天気をDOS風ターミナルで探索できます。コマンドとミッションコントロールの言語は本来の英語表記を維持します。",
    locale: "ja",
    ogLocale: "ja_JP",
    staticLead: "手首のためのミッションコントロール・ターミナル。",
    staticProduct: "SpaceX、NASA、Rocket Lab、ULA、ESA、ISRO、CASCなどの軌道打ち上げを追跡。SPACE CATはWear OSウォッチにライブカウントダウン、ミッション状況、射点の天気、公式配信へのアクセスを表示します。スマートフォンなしで単独動作します。",
    staticStoreStatus: "Wear OS — 配信中 · watchOS — 審査中 · 買い切り · サブスクリプションなし",
    staticNoJs: "JavaScriptがターミナルを接続します。無効でもミッション入口とGoogle Playリンクは利用できます。",
    staticFooter: "データ提供元: Launch Library 2 · RocketLaunch.Live (予備) · NASA/JPL CNEOS · NASA DSCOVR EPIC · NASA APOD · NASA Exoplanet Archive · NASA/JPL Horizons · NOAA SWPC/OVATION · ATNF Pulsar Catalogue参照周期 · SatNOGS DB contributors (CC BY-SA 4.0) · IGWN GraceDB · CelesTrak · Spaceflight News API · Open-Meteo · wheretheiss.at。SpaceX、NASA、その他の宇宙機関とは提携していません。© 2026 BE Engineering。",
    appDescription: "手首で軌道打ち上げを追跡する、単独動作のミッションコントロール・ターミナル。",
  },
  "/de": {
    title: "SPACE CAT :: Live-Raketenstart-Terminal",
    description: "Erkunde echte Raketenstarts mit Live-Countdown, Missionsstatus, Wetter am Startplatz und offiziellen Übertragungslinks in einem Weltraumterminal im DOS-Stil.",
    staticTitle: "LIVE SPACEFLIGHT TERMINAL",
    staticDescription: "Erkunde den nächsten echten Start, den Live-T-0-Countdown, die Position der ISS und das Weltraumwetter in einem Terminal im DOS-Stil. Befehle und Missionskontrollsprache bleiben in ihrer englischen Originalform.",
    locale: "de",
    ogLocale: "de_DE",
    staticLead: "Das Missionskontroll-Terminal für dein Handgelenk.",
    staticProduct: "Verfolge Orbitalstarts von SpaceX, NASA, Rocket Lab, ULA, ESA, ISRO, CASC und weiteren Anbietern. SPACE CAT bringt einen Live-Countdown, den Missionsstatus, das Wetter am Startplatz und den Zugang zur offiziellen Übertragung auf deine Wear-OS-Uhr. Es funktioniert eigenständig, ohne Smartphone.",
    staticStoreStatus: "Wear OS — LIVE · watchOS — in Prüfung · einmaliger Kauf · kein Abonnement",
    staticNoJs: "JavaScript verbindet das Terminal. Ohne JavaScript bleiben die Missionseinstiege und der Google-Play-Link verfügbar.",
    staticFooter: "Datenquellen: Launch Library 2 · RocketLaunch.Live (Reserve) · NASA/JPL CNEOS · NASA DSCOVR EPIC · NASA APOD · NASA Exoplanet Archive · NASA/JPL Horizons · NOAA SWPC/OVATION · Referenzperioden des ATNF Pulsar Catalogue · Mitwirkende der SatNOGS DB (CC BY-SA 4.0) · IGWN GraceDB · CelesTrak · Spaceflight News API · Open-Meteo · wheretheiss.at. Nicht mit SpaceX, NASA oder einer anderen Raumfahrtorganisation verbunden. © 2026 BE Engineering.",
    appDescription: "Ein eigenständiges Missionskontroll-Terminal zur Verfolgung orbitaler Raketenstarts am Handgelenk.",
  },
  "/live": {
